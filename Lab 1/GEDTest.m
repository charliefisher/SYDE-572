...
[g, h] = GEDClassifier(mu_case2, cov_case2, X1, X2);
...
hold on
axis equal
surf(X1, X2, -1.*g(:,:,1), FaceColor='b', EdgeColor='none')
surf(X1, X2, -1.*g(:,:,2), FaceColor='r', EdgeColor='none')
surf(X1, X2, -1.*g(:,:,3), FaceColor='g', EdgeColor='none')
contour(X1,X2,h,'k')
